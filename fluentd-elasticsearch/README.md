...
-   GitHub package registry secret for docker repository with name 'github', see [here](https://kubernetes.io/docs/tasks/configure-pod-container/pull-image-private-registry/) how to create one
